...
const TermsAndConditions = () => {
  return (
    <>
      ...
      <p className="mb-4">Welcome to www.cadpulse.com. These Terms and Conditions govern your use of our website and the purchase and sale of products from our platform. By accessing and using our website, you agree to comply with these terms. Please read them carefully before proceeding with any transactions.</p>

      <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Use of the Website</h2>
      ...
      <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Product Information and Pricing</h2>
      <ol className="list-decimal pl-6 mb-4 space-y-2">
      ...
      <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Shipping and Delivery</h2>
      <ol className="list-decimal pl-6 mb-4 space-y-2">
      ...
      <p className="mb-4">Our Returns and Refund Policy governs the process and conditions for returning products and seeking refunds. Please refer to the policy provided on our website for more information.</p>

      <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Intellectual Property</h2>
      <ol className="list-decimal pl-6 mb-4 space-y-2">
        <li>All content and materials on our website, including but not limited to text, images, logos, and graphics, are protected by intellectual property rights and are the property of www.cadpulse.com or its licensors.</li>
      ...
      <ol className="list-decimal pl-6 mb-4 space-y-2">
        <li>In no event shall www.cadpulse.com, its directors, employees, or affiliates be liable for any direct, indirect, incidental, special, or consequential damages arising out of or in connection with your use of our website or the purchase and use of our products.</li>
      ...
      <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Amendments and Termination</h2>
      <p className="mb-4">We reserve the right to modify, update, or terminate these Terms and Conditions at any time without prior notice. It is your responsibility to review these terms periodically for any changes.</p>
    </>
  );
};
